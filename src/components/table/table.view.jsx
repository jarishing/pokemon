...
export default props => {
    ...
    return (
        <Table 
                ...
                <div className="pkmon-table-title-wrapper" style={{color:props.color}}>
                    ...
                    <div className="pkmon-table-header-wrapper" style={{borderColor:props.color}}>
                        ...
                        <div className="pkmon-table-header" style={{width:'40%', paddingLeft:'30px'}}>
                          {props.subtitle} {props.rankType == "TotalRank"? "":"(%)"}
                        </div>
                    </div>
                </div>
            }
            ...
            width={400}
            rowClassName={
              (record, index) => (record["#"] == parseInt(props.pkmon)? `scroll-row-${props.rankType} hightlight` : '')
                // (record, index) => (index === props.data[parseInt(props.pkmon) - 1][props.rankType] - 1 ? `scroll-row-${props.rankType} hightlight` : '')
            }
        />
    )
}
